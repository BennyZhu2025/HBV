...
# Combine all multivariable results into a single data frame
final_results_df <- bind_rows(multi_results)
...
write.xlsx(final_results_df, "06results_multivariableLR.xlsx", rowNames = FALSE)
# Write the filtered results to an Excel file
write.xlsx(results, "06results_filtered_multivariableLR.xlsx", rowNames = FALSE)
